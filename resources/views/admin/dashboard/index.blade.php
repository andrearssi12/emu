        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center" aria-current="page">
                <a href="{{ route('dashboard') }}"
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Beranda</span>
            ...
            <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                ...
                <article class="mb-5">
                    ...
                    <p class="mb-2 text-gray-900 dark:text-white">
                        ...
                        attaching our offer and pitch deck. Take your time to review everything. I'am looking forward to the
                ...
                <article class="pl-12 mb-5">
                    ...
                    <p class="mb-4 text-gray-900 dark:text-white">
                        Hi <a href="#"
                            class="font-medium hover:underline text-primary-600 dark:text-primary-500">@josephh</a> Sure,
                        just let me know whean you are available and we can speak.
                    </p>
                    <form>
